...
// CSS
$df_stylesheet = '<link rel="stylesheet" href="'.NA_URL.'/css/nariya.css" type="text/css">'.PHP_EOL;
...
add_stylesheet($df_stylesheet, -100);
unset($df_stylesheet);
...
<link rel="stylesheet" href="<?php echo NA_URL ?>/app/bs4/css/bootstrap<?php echo $df_css ?>.min.css" type="text/css">
